    ...
    string LCS(string str1, string str2, int m, int n)
    {
        ...
        while(i > 0 && j > 0)
        {
            ...
            else if(t[i][j-1]>t[i-1][j])
            {
                ...
                --j;
             //jo value greater he uski trf mud jao kyuki uski trf se hum aye he  
            }
...
//dekh agr length deni hoti toh simple lcs lgao and uski length nikal lo and str1 ki  length +str2 ki length - lcs ki length ->scs hogya